...
#include "control_interfaces/msg/detail/position_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const control_interfaces::msg::PositionCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  control_interfaces::msg::PositionCommand & ros_message)
{
  // Member: command
  {
    cdr >> ros_message.command;
...
{
  auto typed_message =
    static_cast<const control_interfaces::msg::PositionCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<control_interfaces::msg::PositionCommand *>(
    untyped_ros_message);
...
{
  return &control_interfaces::msg::typesupport_fastrtps_cpp::_PositionCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_interfaces, msg, PositionCommand)() {
  return &control_interfaces::msg::typesupport_fastrtps_cpp::_PositionCommand__handle;
}
